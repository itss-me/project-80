...
console.log(display_student_array);
document.getElementById("didplay_name_with_commas").innerHTML=display_student_array;

var remove_commas = display_student_array.join(" ");
console.log(remove_commas)
document.getElementById("dislay_name_with_commas").innerHTML = remove_commas;
